# Mongoose (copy from mongoose library doc)
...
```
#### Populate Vs Vistuals API
Mongoose 4.5 introduces a new API for populating documents. The new virtual populate API addresses some significant limitations in the conventional populate API
